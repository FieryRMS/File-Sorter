  ...
  */
  ...
  function () {
    _createClass(ImageViewer, [{
      ...
      key: "imageViewHtml",
      get: function get() {
        return "\n    <div class=\"iv-loader\"></div>\n    <div class=\"iv-snap-view\">\n      <div class=\"iv-snap-image-wrap\">\n        <div class=\"iv-snap-handle\"></div>\n      </div>\n      <div class=\"iv-zoom-actions ".concat(this._options.hasZoomButtons ? 'iv-zoom-actions--has-buttons' : '', "\">\n        ").concat(this.zoomInButton, "\n        <div class=\"iv-zoom-slider\">\n          <div class=\"iv-zoom-handle\"></div>\n        </div>\n        ").concat(this.zoomOutButton, "\n      </div>\n    </div>\n    <div class=\"iv-image-view\" >\n      <div class=\"iv-image-wrap\" ></div>\n    </div>\n  <div class=\"iv-dashboard\">\n    <div class=\"iv-btn iv-rotate-left\">\n        <span class=\"iv-icon\">\n            <img src=\"./assets/rotate-left-solid.svg\" draggable=\"false\">\n        </span>\n    </div>\n    <div class=\"iv-btn iv-rotate-right\">\n        <span class=\"iv-icon\">\n            <img src=\"./assets/rotate-right-solid.svg\" draggable=\"false\">\n        </span>\n    </div>\n</div>");
      }
    }]);
    ...
    function ImageViewer(element) {
      ...
      _defineProperty(this, "zoom", function (perc, point) {
        ...
        var zoom = function zoom() {
          ...
          if (_this._state.rotationValue != 0 && _this._state.rotationValue != 180) {
            css(image, {
              height: `${imgWidth}px`,
              width: `${imgHeight}px`,
              left: `${newLeft}px`,
      ...
      _defineProperty(this, "resetRotation", function () {
      ...
      _defineProperty(this, "showDashboard", function (noTimeout) {
        var _this$_state = _this._state,
            dashboardVisible = _this$_state.dashboardVisible,
            loaded = _this$_state.loaded;
        var dashboard = _this._elements.dashboard;
        if (dashboardVisible || !loaded) return;
        clearTimeout(_this._frames.dashboardTimeout);
        _this._state.dashboardVisible = true;
        css(dashboard, {
          opacity: 1,
          pointerEvents: 'inherit'
        });
        ...
        if (!noTimeout) {
          _this._frames.dashboardTimeout = setTimeout(_this.hideDashboard, 1500);
        }
      });

      _defineProperty(this, "hideDashboard", function () {
        var dashboard = _this._elements.dashboard;
        css(dashboard, {
          opacity: 0,
          pointerEvents: 'none'
        });
        _this._state.dashboardVisible = false;
      });
    ...
    _createClass(ImageViewer, [{
      ...
      value: function _initDom() {
        ...
        this._elements = _objectSpread({}, this._elements, {
          ...
          rotateLeft: container.querySelector(".iv-rotate-left"),
          rotateRight: container.querySelector(".iv-rotate-right"),
          dashboard: container.querySelector(".iv-dashboard")
        });
      ...
      value: function _snapViewEvents() {
        ...
        var _this$_elements3 = this._elements,
            rotateLeft = _this$_elements3.rotateLeft,
            rotateRight = _this$_elements3.rotateRight,
            imageWrap = _this$_elements3.imageWrap,
            dashboard = _this$_elements3.dashboard;
        this._events.rotateLeftClick = assignEvent(rotateLeft, ['click'], function () {
          _this5.rotateLeft();
        });
        this._events.rotateRightClick = assignEvent(rotateRight, ['click'], function () {
          _this5.rotateRight();
        });

        this._events.DashboardOnMouseMove = assignEvent(imageWrap, ['touchmove', 'mousemove'], function () {
          _this5.showDashboard();
        }); // keep showing dashboard if on hover over it without any timeout

        this._events.mouseEnterDashboard = assignEvent(dashboard, ['mouseenter', 'touchstart'], function () {
          _this5._state.dashboardVisible = false;
          
          _this5.showDashboard(true);
        }); // on mouse leave set timeout to hide dashboard

        this._events.mouseLeaveDashboard = assignEvent(dashboard, ['mouseleave', 'touchend'], function () {
          _this5._state.dashboardVisible = false;
      ...
      value: function _calculateDimensions() {
        var _this$_elements7 = this._elements,
            ...
            snapImageImg = _this$_elements7.snapImageImg,
