...
"}")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/assets/volume-high.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        VideoPlayerWidget.setTabOrder(self.PlayPauseBtn, self.VolumeBtn)
